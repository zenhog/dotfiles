...
globalkeys = gears.table.join(
	...
	mapkey(smod, "k", commands.swap_up, "client", "swap up"),
	mapkey(smod, "j", commands.swap_down, "client", "swap down"),
	mapkey(smod, "h", commands.swap_left, "client", "swap left"),
	mapkey(smod, "l", commands.swap_right, "client", "swap right"),
